...
export default function InternshipCard({ internship }) {
  return (
    <div className="overflow-hidden rounded-sm overflow-hidden bg-white shadow-sm transition-shadow hover:shadow-md">
      {/* Image */}
      ...
      <div className="p-5">
        ...
        >
          <InternshipRegistrationForm internshipId={internship?._id} />
        </Modal>
      </div>
    </div>
  );
